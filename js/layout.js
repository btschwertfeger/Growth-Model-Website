...
const initial_weight_input = document.getElementById("weight_input_simple"),
...
temp_slider_simple.onchange = () => {
  window.plot_simple(
    parseFloat(temp_slider_simple.value),
    parseFloat(initial_weight_input.value),
  );
};
...
document.getElementById("complex_back_image").onclick = () => {
  ...
  else if (image_src.includes(image2))
    document.getElementById("complex_image").src = image1;
  else if (image_src.includes(image3))
    document.getElementById("complex_image").src = image2;
};
document.getElementById("complex_next_image").onclick = () => {
  const image_src = document.getElementById("complex_image").src;
  if (image_src.includes(image3)) return;
  else if (image_src.includes(image1))
    document.getElementById("complex_image").src = image2;
  else if (image_src.includes(image2))
    document.getElementById("complex_image").src = image3;
};
...
const A_R_input = document.getElementById("A_R_adj_slide"),
...
const A_R_amount = document.getElementById("A_R_adj_slide_amount"),
